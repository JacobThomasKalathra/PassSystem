...
<body>
    ...
    <tbody><tr bgcolor="#eaeff5">
	      <td valign="center">&nbsp;&nbsp;
	        <font class="pageTitle"><?php echo "Remove Existing User-Id & Password from PMS! ";?></font>
	      </td>
    </tr>
   </tbody></table>
...
<p>&nbsp;</p>
 ...
 <form method=get action="remove_pass.php">
<center>
...
<tr>
		...
		<input type=button onclick="window.location='admin_page.php';" value="Back"/>

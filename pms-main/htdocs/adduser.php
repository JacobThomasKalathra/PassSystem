...
self.location='adduser.php?cat=' + val + '&subcat=' + val2 + '&cat3=' +val3;
...
<p>&nbsp;</p>
 ...
 <form name="adduser" method="get" action="add_user.php">
<center>
				...
				<?Php
						...
						$quer2="SELECT DISTINCT grp FROM base";
							...
							$quer2="SELECT DISTINCT grp FROM base where exists (SELECT email FROM user_list WHERE base.subgrp = user_list.subgroup and base.grp= user_list.grp and user_list.admin= 'Y' and user_list.email='$login_session')"; 
								...
								echo "<form method=post name=f1 action='adduser.php'>";
						...
						var val = "'.$cat.'";
						var val2 ="'.$subcat.'";
                      self.location="adduser.php?cat=" +  val "&subcat="+ val2;
                      ...
                      self.location="adduser.php?cat=" + val ;
...
<tr>
		...
		<td class="ASOD_TH_25">
			...
			<tbody><tr>
				...
				echo "<form method=post name=f2 action='adduser.php'>";
...
<tr>
		...
		<td class="ASOD_TH_25">
			...
			<tbody><tr>
				...
				<input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" required></BR><font  color="#4c6d9a" size="1"  style="float:right">Example: abc.xyz@oracle.com</font>
				</td>
			</tr>
			</tbody></table>
		</td>
...
<tr>
		...
		<tr> <p>&nbsp;</p>
			 ...
			 <input class='submit' value='ADD USER' type='submit'>

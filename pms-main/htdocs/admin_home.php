...
$rs= "SELECT count (*) from password_list WHERE  (lower(userid) like :l  or lower(description) like:l)  and EXISTS ( SELECT email FROM user_list WHERE user_list.subgroup = password_list.subgrp and user_list.grp= password_list.grp and UPPER(user_list.email)=UPPER(:e))";

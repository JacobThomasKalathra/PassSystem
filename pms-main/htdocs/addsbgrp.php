...
self.location='addsbgrp.php?cat=' + val ;
}
...
<p>&nbsp;</p>
 ...
 <form name="addsbgrp" method="get" action="add_sbgrp.php">
<center>
				...
				<?Php
						...
						@$cat=$_GET['cat']; 
							...
							$quer2="SELECT DISTINCT grp FROM base"; 
								...
								echo "<form method=post name=f1 action='addsbgrp.php'>";
...
<tr>
			...
			<tbody><tr>
				...
				<td valign="top" width="225"><b class="pageTitle">* Add New Subgroup:</b>
